  ...
  return (
    <>
              ...
              <Table>
                ...
                <TableBody>
                  {sortedTransactions.map((transaction, index) => (
                    <TableRow key={index} className="cursor-pointer" onClick={() => setIsTransactionModalOpen(true)}>
      ...
      {isTransactionModalOpen && (
        <Modal title="Ajouter une transaction" description="Ajouter une transaction à votre portefeuille.">
          <p>test</p>
        </Modal>
      )}
    </>
